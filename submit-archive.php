            ...
            $.ajax({
                ...
                success: function(resp){
                    if(resp.status == 'success'){
                        // Archive saved successfully, now call repository function
                        $.ajax({
                            url: _base_url_+"classes/Master.php?f=save_repository",
                            data: new FormData($('#archive-form')[0]),
                            cache: false,
                            contentType: false,
                            processData: false,
                            method: 'POST',
                            ...
                            error: err=>{
                                console.log(err);
                                // Optionally handle repository save error
                            },
                            success: function(repoResp){
                                // After repository save, redirect to view archive page
